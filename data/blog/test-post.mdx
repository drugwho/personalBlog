...
6. Lastly, in the app level build.gradle file (same file as above), find the applicationId and change it to the name you chose in step 2. In my case I used com.raghuganapathy.medium_tutorial.
...
I changed mine from com.example.mediumTutorial to com.raghuganapathy.mediumTutorial.
